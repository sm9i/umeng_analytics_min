package com.rzy.plugin.umeng_analytics_min
...
class UmengAnalyticsMinPlugin : MethodCallHandler {
    companion object {
        @JvmStatic
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "umeng_analytics_min")
            channel.setMethodCallHandler(UmengAnalyticsMinPlugin(registrar.activity()))
        }
    }
